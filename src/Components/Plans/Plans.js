  ...
  return (
    <div>
      <div class="lg:flex lg:flex-col lg:items-center">
        <h1 class="text-gray-700 text-4xl md:text-6xl lg:text-8xl font-extrabold flex items-center justify-center mt-16 lg:mt-48">
          Choose your pricing
        </h1>
        <h1 class="text-gray-700 text-4xl md:text-6xl lg:text-8xl font-extrabold flex items-center justify-center ">
          plan
        </h1>
        <p class="text-gray-700 font-normal text-lg md:text-4xl flex items-center justify-center py-5 lg:py-10">
      ...
      <div>
        <div class="flex flex-col md:flex-row md:items-center md:justify-center">
          <div class="border mx-auto h-full md:w-80 flex flex-col items-center overflow-hidden mb-4 md:mb-0 ">
            <h1 class="my-4 text-2xl font-bold tracking-widest">Silver Plan</h1>
            <div class="flex items-center">
              <pre class="text-xl">$</pre>
              <h1 class="text-6xl">10</h1>
            </div>
            <h1>Every Month</h1>
            <h1 class="py-5 font-light">All Basic SEO Tools</h1>
            <h1 class="font-light">1-day free trial</h1>
            <button class="border px-12 mt-6 mb-5 py-1 bg-[#9e3ffd] text-white tracking-widest">
              Start Free Trial
            </button>
            <h1 class="border-t-2 pt-6 font-bold flex items-center">
              <i class="text-[#9e3ffd] fas fa-check-circle px-3"></i>
              UberSuggest
            </h1>
            <h1 class="pt-4 font-bold flex items-center">
              <i class="text-[#9e3ffd] fas fa-check-circle px-3"></i>
              Grammarly
            </h1>
            <h1 class="pt-4 font-bold flex items-center">
          ...
          <div class="border mx-auto h-full md:w-80 flex flex-col items-center overflow-hidden mb-4 md:mb-0">
            ...
            <h1>Every Month</h1>
            <h1 class="pt-5 font-light">Everything in Silver Plan</h1>
            <h1 class="font-light mb-6">+ More</h1>
            <h1 class="font-light">1-day free trial</h1>
            <button class="border px-12 mt-6 mb-5 py-1 bg-[#9e3ffd] text-white tracking-widest">
              Start Free Trial
            </button>
            ...
            <h1 class="pt-4 font-light flex items-center">
              <i class="text-[#9e3ffd] fas fa-check-circle px-3"></i>
              Majestic
            </h1>
            <h1 class="pt-4 font-light flex items-center">
      ...
      <div class="container mt-10">
        <div class="grid gap-x-8 grid-cols-1 md:grid-cols-3">
          <div class="border w-80 mx-auto flex items-center flex-col overflow-hidden">
            <h1 class="my-4 text-2xl font-bold tracking-widest">
              Diamond plan
            </h1>
            <div class="flex">
            ...
            <button class="border px-12 mt-6 mb-5 py-3 bg-[#9e3ffd] text-white tracking-widest">
              Start Free Trial
            </button>
            <h1 class="border-t-2 w-full text-center py-6 font-light">
              <i class="px-3 text-[#9e3ffd] fa-sharp fa-solid fa-circle-check"></i>{' '}
              SpyFu
            </h1>
          </div>
      ...
      <div class="container mt-10">
        <div class="grid gap-x-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
          <div class="border w-80 mx-auto flex items-center flex-col overflow-hidden">
            <h1 class="my-4 text-2xl font-bold tracking-widest">ADSPY</h1>
            <div class="flex">
              <pre>$</pre>
              <h1 class="text-6xl">10</h1>
            </div>
          ...
          <div class="border w-80 mx-auto flex items-center flex-col overflow-hidden">
            <h1 class="my-4 text-2xl font-bold tracking-widest">BigSpy</h1>
            <div class="flex">
              <pre>$</pre>
              <h1 class="text-6xl">10</h1>
            </div>
      ...
      <div class="container mx-auto mt-10">
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3">
          <div class="flex flex-col items-center border w-full overflow-hidden">
            <h1 class="my-4 text-2xl font-bold tracking-widest">
              Envato Elements
            </h1>
            <div class="flex">
            ...
            <h1 class="mt-2 font-medium">Every Month</h1>
            <h1 class="mt-auto font-light">1 day free trial</h1>
            <button class="mt-6 mb-5 px-12 py-3 text-white bg-[#9e3ffd] border border-[#9e3ffd] tracking-widest">
              Start Free Trial
            </button>
            <h1 class="w-full py-6 border-t-2 text-center font-light">
              <i class="px-3 fa-solid fa-circle-check fa-lg text-[#9e3ffd]"></i>{' '}
              Envato Elements
            </h1>
          </div>
          <div class="flex flex-col items-center border w-full overflow-hidden">
            <h1 class="my-4 text-2xl font-bold tracking-widest">Vistacreate</h1>
            <div class="flex">
              <span class="text-lg">$</span>
              <h1 class="text-6xl">10</h1>
            </div>
          ...
          <div class="flex flex-col items-center border w-full overflow-hidden">
            <h1 class="my-4 text-2xl font-bold tracking-widest">Veed.io</h1>
            <div class="flex">
              <span class="text-lg">$</span>
              <h1 class="text-6xl">10</h1>
            </div>
      ...
      <div class="container mt-10">
        <div class="grid gap-x-8 grid-cols-1 md:grid-cols-3">
          <div class="border w-80 mx-auto flex flex-col items-center overflow-hidden">
            <h1 class="my-4 text-2xl font-bold tracking-widest">Canva Pro</h1>
            <div class="flex">
              <pre>$</pre>
              <h1 class="text-6xl">3</h1>
            </div>
          ...
          <div class="border w-80 mx-auto flex flex-col items-center mt-8 md:mt-0 md:border-t md:border-b md:border-l-2 md:border-r-2  md:px-6 overflow-hidden">
            <h1 class="my-4 text-2xl font-bold tracking-widest">StoryBlocks</h1>
            <div class="flex">
              <pre>$</pre>
              <h1 class="text-6xl">10</h1>
            </div>
          ...
          <div class="border w-80 mx-auto flex flex-col items-center mt-8 md:mt-0">
            <h1 class="my-4 text-2xl font-bold tracking-widest">
              Diamond Plans
            </h1>
            <div class="flex">
            ...
            <h1 class="w-full text-center py-6 font-light">
              <i class="px-3 text-[#9e3ffd] fa-sharp fa-solid fa-circle-check"></i>
              Canva
            </h1>
          </div>
      ...
      <div class="container mt-10">
        <div class="grid gap-x-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          <div class="border w-80 mx-auto flex flex-col items-center overflow-hidden">
            <img
            ...
            <div class="flex">
              <pre>$</pre>
              <h1 class="text-8xl font-extrabold">15</h1>
            </div>
            <h1>Every Month</h1>
            <h1 class="pt-5 font-light">Everything in Gold Plan + More</h1>
            <h1 class="font-light pt-4">Valid until canceled</h1>
            <h1 class="font-light">1 day free trial</h1>
            <button class="border px-12 mt-6 mb-5 py-3 bg-[#9e3ffd] text-white tracking-widest">
              Start Free trial
            </button>
            <h1 class="border-t-2 px-12 pt-6 font-light">
              <i class="px-3 text-[#9e3ffd] fa-sharp fa-solid fa-circle-check"></i>{' '}
              Everything in Silver
            </h1>
            <h1 class="pt-4 font-light">
              <i class="px-3 text-[#9e3ffd] fa-sharp fa-solid fa-circle-check"></i>{' '}
              Majestic
            </h1>
            <h1 class="pt-4 font-light">
          ...
          <div class="border w-80 mx-auto flex flex-col items-center overflow-hidden">
            ...
            <div class="flex">
              <pre>$</pre>
              <h1 class="text-8xl font-extrabold">29</h1>
            </div>
            <h1>Every Month</h1>
            <h1 class="pt-5 font-light">Everything in Gold Plan + More</h1>
            <h1 class="font-light pt-4">Valid until canceled</h1>
          ...
          <div class="border w-80 mx-auto flex flex-col items-center overflow-hidden">
            ...
            <div class="flex">
              <pre>$</pre>
              <h1 class="text-8xl font-extrabold">80</h1>
            </div>
            <h1>Every Month</h1>
            <h1 class="pt-5 font-light">Everything in Gold Plan + More</h1>
            <h1 class="font-light pt-4">Valid until canceled</h1>
